...
namespace UI
{
    ...
    public class GridEx : MonoBehaviour
    {
        public GridExItem itemPrefab;
        ...
        {
            items = new List<GridExItem>();
            recycledItems = new List<GridExItem>();
            itemTotalCount = 0;
        ...
        public GridExItem GetAvailableItem()
        {
            GridExItem item = null;
            ...
            if (index < 0)
            {
                ...
                item = go.GetComponent<GridExItem>();
                item.grid = this;
        ...
        public List<T> GetItems<T>() where T : GridExItem
        {
        ...
        public void SelectItemByItem(GridExItem item, bool focusTo, bool flashTo)
        {
        ...
        public void OnItemSelect(GridExItem item, bool isClickMsg)
        {
        ...
        //@param item GridItem
        public bool IsItemVisible(GridExItem item)
        {
        ...
        public void GetDistToClipBorder(GridExItem item, out float t, out float b, out float l, out float r)
        {
            t = b = l = r = 0;
            if (scrollView == null || item == null)
            {
        ...
        public T GetSelectItem<T>() where T : GridExItem
        {
