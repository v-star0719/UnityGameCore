...
namespace GameCore.Unity.BlurTextureMaker
{
    public class BlurTextureMakingData
    {
    ...
    public class BlurTextureMaker : MonoBehaviour
    {
        ...
        public IEnumerator Process(Texture texture, BlurTextureMakingData rt)
        {
        ...
        public static BlurTextureMakingData Blur(Texture2D texture)
        {
            ...
            var rt = new BlurTextureMakingData();
            rt.coroutine = instance.StartCoroutine(instance.Process(texture, rt));
            return rt;
        }

        public static void Stop(BlurTextureMakingData makeData)
        {
